...
def load_from_pretrained_with_local_fallback(loader, model_name: str, **kwargs):
    try:
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run the setup6_2 TIRA submission on a TIRA dataset id or local input directory."
    )
    parser.add_argument(
        "--dataset",
        default=None,
